  ...
  return (
    <section className='call-action-img'>
      <div className='container'>
        <div className='sec-bg-img bg-img parallaxie' data-background={project.images[4].url}></div>
        <div className='sec-lg-head section-padding'>
          <div className='row ontop'>
            <div className='col-11 d-flex align-items-center'>
              <div>
                <h6 className='sub-title'>{nextProject ? 'Next Project' : 'No more projects'}</h6>
                <h2 className='fz-50 d-rotate wow'>
                  <div className='rotate-text'>{nextProject ? nextProject.title : 'Back to main page?'}</div>
                </h2>
              </div>
              <div className='ml-auto'>
                <Link href={linkHref}
                  ...
                  <div className='full-width'>
                    ...
                    <span className='full-width'>{nextProject ? 'Next Project' : 'Homepage'}</span>
                  </div>
