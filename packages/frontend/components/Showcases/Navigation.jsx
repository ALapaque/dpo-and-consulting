...
const Navigation = ({isOpen, toggle, lightMode, alwaysDark, darkOnScroll}) => {
    ...
    const toggleMenuStyle = (state) => {
        ...
        if (state) {
            ...
            nav.querySelector('div.menu-button').style.color = alwaysDark ? 'black' : 'white';
            nav.querySelector('span.menu-button__icon').style.color = alwaysDark ? 'black' : 'white';
            nav.querySelector('span.menu-button__text').style.color = alwaysDark ? 'black' : 'white';
        }
    }
        ...
        <div
            ...
            <div className='container'>
                ...
                <div
                    ...
                    <span className='menu-button__icon icon'><i></i><i></i></span>
